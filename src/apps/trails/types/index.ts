...
export interface DurableMediaAssetRegistryStore {
  ...
  approvePublicDerivatives(actor: Actor, mutation: DurableCommerceMutation & { assetId: string; publication: ServerApprovedPublicDerivativePublication }): Promise<DurableMediaAsset>;
