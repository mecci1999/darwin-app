              ...
              content: {
                ...
                usage: {
                  ...
                  apiCalls: {
                    ...
                    overage: Math.max(
                      0,
                      (usage.apiCalls?.total || usage.apiCalls || 0) - billing.includedApiCalls,
                    ),
    ...
    'v1.billing.estimate': {
      ...
      async handler(ctx: Context): Promise<HttpResponseItem> {
        try {
          ...
          // 计算预估费用
          const estimatedBilling = await (this as any).calculateUsageBilling(
            subscription,
            estimatedUsage,
          );
          ...
          return {
            ...
            data: {
              ...
              content: {
                ...
                recommendations: await (this as any).getBillingRecommendations(
                  userId,
                  estimatedBilling,
                ),
              },
